...
create table LesZones (numZ number (4) NOT NULL AUTO_INCREMENT, nomC varchar2(20), 
...
create table LesSpectacles (numS number (4) NOT NULL AUTO_INCREMENT, nomS varchar2(40), 
...
create table LesDossiers (noDossier number (4) NOT NULL AUTO_INCREMENT, montant number (6,2),
